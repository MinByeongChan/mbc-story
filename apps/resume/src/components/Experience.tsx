...
const experiences: CompanyExperience[] = [
  {
    ...
    projects: [
      ...
      },
      {
        ...
        skills: 'React, Vue 3, TypeScript, Pinia, Redux Toolkit, SCSS, Jest, Storybook, Cypress',
        link: {
      ...
      },
      {
        ...
        skills: 'React, TypeScript, TanStack Query, Jotai, Cypress, Datadog RUM, Vite, AWS',
        link: {
