...
export const Projects = () => (
  <>
    ...
    <ListItems>
      ...
      <ListItem>
        <p>React.js, Typescript, TanStack Query, jotai, vite, AWS (S3, CloudFront) 사용</p>
      </ListItem>
    </ListItems>
    ...
    <ListItems>
      ...
      <ListItem>
        <p>각 회원서비스에 제공되는 마이페이지, 로그인, 계정 찾기, 회원가입 페이지 개발.</p>
      </ListItem>
      <ListItem>
        <p>유닛테스트부터 통합테스트까지 개발팀 내부에서 진행하여 버그를 최소한으로 줄임.</p>
      </ListItem>
      <ListItem>
        <p>
    ...
    <ListItems>
      ...
      <ListItem>
        <p>어드민 회원별 권한을 제어하여 각각 다른 메뉴를 접근할 수 있도록 제어하는 로직 개발.</p>
      </ListItem>
      <ListItem>
        <p>
      ...
      <ListItem>
        <p>React, Typescript, Redux(RTK / redux-thunk), vite, AWS (S3, CloudFront) 사용</p>
      </ListItem>
    </ListItems>
    ...
    <ListItems>
      <ListItem>
        <p>KSNET VAN/PG 가맹점에 대한 매출정보확인 앱 리뉴얼 및 서비스 유지보수</p>
      </ListItem>
      <ListItem>
